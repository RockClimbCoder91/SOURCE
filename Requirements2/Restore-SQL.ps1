    ...
    try {
        ...
        if ($checkDbResult.DatabaseExists -eq 1) {
            ...
            try {
                ...
                Write-Host "Failed to delete the database: $_"
                throw $_
            }
        } else {
        ...
        try {
            ...
            Write-Host "Failed to create the database: $_"
            throw $_
        }
...
"@
            ...
            Write-Host "Failed to create the table: $_"
            throw $_
        }
...
"@
        ...
        try {
            ...
            Write-Host "Failed to export data to 'SqlResults.txt': $_"
        }

    } catch {
        Write-Host "An error occurred during the database setup or data insertion process: $_"
    }
